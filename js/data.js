...
(function (global) {
  ...
  const CATEGORIES = [
    ...
    {
      id: 'canta',
      img: 'koleksiyonlar/canta/canta-nice-lifestyle-1.jpg',
      ratio: 3/4,
      tr: 'Çanta & Aksesuar Koleksiyonu',
      en: 'Tote Bag & Accessories Collection',
      fr: 'Collection Sacs Cabas & Accessoires',
      d: {
        tr: 'Ağır gramajlı %100 pamuk kanvas omuz ve sahil çantaları (tote bag) ile şişe kılıfları. Fransız kıyı desenleri ve otantik sahil armalarıyla eko-baskılı.',
        en: 'Heavyweight 100% cotton canvas shoulder and beach tote bags, bottle sleeves. Eco-printed with French coastal insignias and authentic regional motifs.',
  ...
  const I18N = {
    tr: {
      ...
      'ui.lang': 'Dil seçimi',
      'ui.menu': 'Menüyü aç',
      'ui.closeMenu': 'Menüyü kapat',
      'ui.close': 'Kapat',
      'ui.prev': 'Önceki',
      'ui.next': 'Sonraki',
      'ui.prevModel': 'Önceki model',
      'ui.nextModel': 'Sonraki model',
      'ui.variant': 'Varyant',
      'ui.sliderStatus': 'Görüntülenen model:',
      ...
      'panel.attach': 'Desen Seç & Ekle / Değiştir',
      'panel.openCatalog': 'E-Kataloğu Aç',
      'panel.back': 'Geri',
      'panel.noDesign': 'Şu an görüntülenen model. "Desen İstemiyorum" ile desensiz, "Desen Seç & Ekle / Değiştir" ile modele desen bağlayarak teklife ekleyin.',
      ...
      'pending.plainFirst': 'Önce bir üründen "Desen Seç & Ekle / Değiştir"e tıklayın',
    ...
    en: {
      ...
      'ui.prev': 'Previous',
      'ui.next': 'Next',
      'ui.prevModel': 'Previous model',
      'ui.nextModel': 'Next model',
      'ui.variant': 'Variant',
      'ui.sliderStatus': 'Model shown:',
      ...
      'panel.attach': 'Choose & Attach / Change Design',
      'panel.openCatalog': 'Open E-Catalog',
      'panel.back': 'Back',
      'panel.noDesign': 'This is the model you are viewing. Add it plain, or attach/change a regional design with "Choose & Attach / Change Design".',
      ...
      'pending.plainFirst': 'First click "Choose & Attach / Change Design" on a product',
    ...
    fr: {
      ...
      'ui.nav': 'Navigation principale',
      'ui.lang': 'Choix de la langue',
      'ui.menu': 'Ouvrir le menu',
      'ui.closeMenu': 'Fermer le menu',
      'ui.close': 'Fermer',
      'ui.prev': 'Précédent',
      'ui.next': 'Suivant',
      'ui.prevModel': 'Modèle précédent',
      'ui.nextModel': 'Modèle suivant',
      'ui.variant': 'Variante',
      'ui.sliderStatus': 'Modèle affiché :',
      'nav.collections': 'Gammes',
      ...
      'hero.title1': 'Pour hôtels & boutiques de souvenirs,',
      ...
      'panel.attach': 'Choisir & Associer / Modifier un Motif',
      'panel.openCatalog': 'Ouvrir l’E-Catalogue',
      'panel.back': 'Retour',
      'panel.noDesign': 'Voici le modèle affiché. Ajoutez-le uni, ou associez/modifiez le motif via « Choisir & Associer / Modifier un Motif ».',
      ...
      'pending.plainFirst': 'Ouvrez d’abord un produit puis choisissez « Choisir & Associer / Modifier un Motif »',
