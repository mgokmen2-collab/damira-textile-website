...
(function (global) {
  ...
  const CATEGORIES = [
    {
      ...
      badge: { tr: '%100 Ege Pamuğu', en: '100% Aegean Cotton', fr: '100% Coton Égéen' },
      d: {
    ...
    },
    {
      ...
      badge: { tr: '550 g/m² Ekstra Bukle', en: '550 g/m² Extra Plush', fr: '550 g/m² Bouclette Dense' },
      d: {
    ...
    },
    {
      ...
      badge: { tr: 'El Düğümlü Saçaklar', en: 'Hand-Tied Fringes', fr: 'Franges Nouées Main' },
      d: {
    ...
    },
    {
      ...
      badge: { tr: 'Elmas Jakar Dokuma', en: 'Diamond Jacquard', fr: 'Jacquard Losange' },
      d: {
    ...
    },
    {
      ...
      badge: { tr: 'Eko-Baskı & Kanvas', en: 'Eco-Print & Heavy Canvas', fr: 'Impression Éco & Toile Écrue' },
      d: {
    ...
    },
    {
      ...
      badge: { tr: 'Özel Seri Nakış', en: 'Fine Breed Embroidery', fr: 'Broderies de Race' },
      d: {
  ...
  const I18N = {
    tr: {
      ...
      'hero.eyebrow': 'NICE · FRANSA | TOPTAN TURİSTİK & OTEL TEKSTİLİ',
      'hero.title1': 'Riviera’nın Zarafeti,',
      'hero.title2': '%100 Ege Pamuğu ile Buluşuyor.',
      'hero.lede': 'Otel, butik ve konsept mağazalar için lüks bornoz, havlu, pike, peştemal, çanta ve hediyelik koleksiyonları. Hassas nakış ve yüksek çözünürlüklü baskı üretimi.',
      'hero.badge1': '%100 Ege Pamuğu',
      'hero.badge2': 'Özel Nakış & Baskı',
      'hero.badge3': '25 Bölgesel Desen',
      'hero.badge4': 'Min. 100 Adet · B2B',
      'hero.cta1': 'E-Kataloğu İncele',
      'hero.cta2': 'Numune & Fiyat Teklifi',
      'hero.note': 'B2B · Min. sipariş: 100 adet / model · Fransa depo ve tüm Avrupa’ya doğrudan teslimat',
      'hero.caption': 'COQ D’OR — Riviera Koleksiyon Vitrini, %100 Ege Pamuğu & Özel Nakış',

      'collections.eyebrow': 'ÜRÜN GRUPLARIMIZ',
      'collections.title': '6 Temel Kategori, Kusursuz Ege Dokusu.',
      'collections.lede': 'Bornozdan havluya, p彆keden şarap çantasına; her ürün grubu en kaliteli %100 Ege pamuğu iplikleriyle üretilir.',

      'catalog.eyebrow': 'DESEN ARŞİVİ',
      'catalog.title': '25 Fransız Sahil Şehri, Kumaşa İşlenmiş Anılar.',
    ...
    en: {
      ...
      'hero.eyebrow': 'NICE · FRANCE | WHOLESALE RESORT & HOTEL TEXTILES',
      'hero.title1': 'Riviera Elegance Meets',
      'hero.title2': '100% Aegean Cotton.',
      'hero.lede': 'Luxury bathrobe, towel, piqué, fouta, canvas bag and souvenir collections for high-end hotels, resorts and concept boutiques. Precision embroidery and eco-printing wholesale production.',
      'hero.badge1': '100% Aegean Cotton',
      'hero.badge2': 'Embroidery & Print',
      'hero.badge3': '25 Regional Designs',
      'hero.badge4': 'Min. 100 Pcs · B2B',
      'hero.cta1': 'Explore E-Catalog',
      'hero.cta2': 'Samples & Pricing',
      'hero.note': 'B2B Wholesale · Min. order: 100 pcs / style · Direct delivery across Europe',
      'hero.caption': 'COQ D’OR — Riviera Showcase: 100% Aegean Cotton with Fine Embroidery',

      'collections.eyebrow': 'OUR PRODUCT RANGES',
      'collections.title': '6 Core Categories, Unmatched Tactile Luxury.',
      ...
      'catalog.title': '25 French Coastal Cities, Stitched Memories.',
    ...
    fr: {
      ...
      'hero.eyebrow': 'NICE · FRANCE | LINGE D’HÔTELLERIE ET BOUTIQUES EN GROS',
      'hero.title1': 'L’Élégance de la Riviera,',
      'hero.title2': 'Sublimée par le 100% Coton Égéen.',
      'hero.lede': 'Collections haut de gamme de peignoirs, serviettes, piqués, foutas, sacs à vin et cadeaux pour hôtels de prestige et boutiques balnéaires. Broderie haute précision et impression écologique.',
      'hero.badge1': '100% Coton Égéen',
      'hero.badge2': 'Broderie & Impression',
      'hero.badge3': '25 Villes Côtieres',
      'hero.badge4': 'Min. 100 Pcs · B2B',
      'hero.cta1': 'Consulter l’E-Catalogue',
      'hero.cta2': 'Échantillons & Tarifs',
      'hero.note': 'Commandes B2B · Min. : 100 pcs / modèle · Dépôt en France et livraison Europe',
      'hero.caption': 'COQ D’OR — Vitrine Riviera : 100% Coton Égéen et Broderie Fine au Fil d’Or',

      'collections.eyebrow': 'NOS GAMMES PRODUITS',
      'collections.title': '6 Catégories Essentielles, Douceur Égéenne Incomparable.',
      ...
      'catalog.title': '25 Villes Balnéaires Françaises, Souvenirs Ciselés.',
